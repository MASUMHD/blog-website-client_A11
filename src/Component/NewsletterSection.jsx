    ...
    <div className="grid md:bg-gray-200 mb-[450px] p-3 md:mb-0  grid-cols-1 md:grid-cols-3 border-2 rounded-2xl h-96 md:w-1/2  mx-auto">
      ...
      <div className="">
        ...
        <div>
          ...
          >
            <input
              className=" md:ml-32 mt-10 border-4 border-[#609beb]  rounded-3xl w-full p-2"
              type="email"
              name="email"
              required
            ...
            <input
              // onClick={notify}
              className=" md:ml-32 mt-5 border-4 border-white  rounded-3xl w-full p-2 bg-[#609beb] btn"
              type="submit"
              value="Subscribe"
            />
          </form>
